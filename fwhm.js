...
// so that background border pixels are symmetric around the star — an off-centre
// cursor would otherwise skew the background estimate and produce negative
...
function calculateAdaptiveFWHM(x, y, _plateScale) {
    ...
    ({ array, offsetX, offsetY } = extractSubarray(imageData, peakX, peakY, boxSize));
